...
const CashierPayments: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await api.payments.mine(params);
      setItems(res.data.payments || []);
      setTotal(res.data.pagination?.total || 0);
    } catch (e: any) {
      console.error('Fetch my payments error', e);
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Historial de pagos registrados por ti</p>
          </div>
        </div>
        <div className="text-right bg-gradient-to-r from-purple-50 to-indigo-50 px-4 py-3 rounded-xl border-2 border-purple-200">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-gray-200 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <div className="flex items-end">
            <button 
              onClick={() => { setFrom(''); setTo(''); setMethod(''); setPage(1); fetchData(); }} 
      ...
      <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 overflow-hidden">
        <div className="px-6 py-5 border-b-2 border-gray-200 bg-gradient-to-r from-gray-50 to-blue-50">
          ...
          <p className="text-sm text-gray-600 mt-1 font-medium">Lista de todos tus pagos registrados</p>
        </div>
